    ...
    <v-main>
        <v-card>
            <v-list-item>
                ...
                <v-list-item-content>
                    <v-list-item-title class="headline" style="font-weight: bold;">Dashboard</v-list-item-title>
                </v-list-item-content>
            </v-list-item>
        </v-card>
        <v-item-group>
            <v-container>
                <v-row>
                    <v-card :loading="loading" dark color="#ff6a00" class="my-6" max-width="374">
                        ...
                        <v-card-title style="justify-content: center" class="white black--text mt-5"><strong> CEPAT
                            </strong></v-card-title>
                    ...
                    <v-card :loading="loading" class="ml-5 my-6" dark color="#ff6a00" max-width="374">
                        <v-img height="250" class="mt-5"
                        ...
                        <v-card-title style="justify-content: center" class="mt-5 white black--text"><strong> TEPAT
                            </strong></v-card-title>
                    ...
                    <v-card :loading="loading" class="ml-5 my-6" dark color="#ff6a00" max-width="374">
                        ...
                        <v-card-title style="justify-content: center" class="mt-5 white black--text"><strong> AKURAT
                            </strong></v-card-title>
