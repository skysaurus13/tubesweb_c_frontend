  ...
  <v-main class="list">
    <v-card>
        <v-list-item>
            ...
            <v-card-title>
                <v-btn color="success" dark :to="{name: 'updateProfile'} " >Edit Profil</v-btn>
            </v-card-title>
        </v-list-item>
    </v-card>
    <v-card>
        <v-form>
            <v-container>
                <v-row>
                    <v-col cols="12" md="10">
                        <v-text-field label="Nama"  v-model="user.name" readonly> {{user.name}}</v-text-field>
                    </v-col>
                    <v-col cols="12" md="10">
                        <v-text-field v-model="user.email" label="Email" readonly> {{user.email}} </v-text-field>
                    </v-col>
                    <v-col cols="12" md="10">
                        <v-text-field v-model="user.nomorTelepon" label="Nomor Telepon" readonly>{{user.nomorTelepon}}</v-text-field>
                    </v-col>
                </v-row>
            </v-container>
        </v-form>
